...
import edu.usst.jayce.server.listener.ServerInitListener;
...
import edu.usst.jayce.server.pojo.CheckImportFolderRespons;
import edu.usst.jayce.server.pojo.CheckUploadFilesRespons;
import edu.usst.jayce.server.service.FileService;
...
public class FileServiceImpl extends RangeFileStreamWriter implements FileService {
	...
	public void downloadCheckedFilesZip(final HttpServletRequest request, final HttpServletResponse response)
		...
		if (zipname != null && !zipname.equals("ERROR")) {
			...
			String fname = "CloudDisk_" + ServerTimeUtil.accurateToDay() + "_\u6253\u5305\u4e0b\u8f7d.zip";
			if (zip.exists()) {
