...
import edu.usst.jayce.server.pojo.FolderView;
import edu.usst.jayce.server.pojo.RemainingFolderView;
import edu.usst.jayce.server.pojo.SreachView;
import edu.usst.jayce.server.service.FolderViewService;
...
public class FolderViewServiceImpl implements FolderViewService {
	...
	@Override
	public String getSearchViewToJson(HttpServletRequest request) {
		final ConfigureReader cr = ConfigureReader.instance();
