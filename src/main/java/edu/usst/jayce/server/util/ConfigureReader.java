...
import edu.usst.jayce.server.enumeration.*;
...
public class ConfigureReader {
	...
	private DProperties serverp;// 配置设置
	private DProperties accountp;// 账户设置
	...
	private ConfigureReader() {
		...
		this.serverp = new DProperties();
		this.accountp = new DProperties();
